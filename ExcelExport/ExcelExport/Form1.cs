...
namespace ExcelExport
{
    public partial class Form1 : Form
    {
        ...
        private void FormatTable()
        {
            ...
            Excel.Range completeRange = xlSheet.get_Range(GetCell(1, 1), GetCell(lastRowID, headers.Length));
            completeRange.BorderAround2(Excel.XlLineStyle.xlContinuous, Excel.XlBorderWeight.xlThick);
        }
    }
}
